...
1️⃣ <b>Скачайте полученный файл конфигурации</b>

Сохраните файл <code>.conf</code> на ваше устройство.
...
4️⃣ <b>Выберите конфигурацию</b>

Выберите скачанный файл:

<code>.conf</code>

WireGuard автоматически загрузит настройки VPN.

---

5️⃣ <b>Включите VPN</b>

Нажмите кнопку подключения.

После успешного подключения появится:
